...
?>
	...
	<div class="notice notice-info" style="padding-right: 38px;position: relative;">
		<h4>If you are looking for an Identity Provider,you can try out <a href="https://idp.miniorange.com" target="_blank" >miniOrange On-Premise IdP</a>.</h4>
		<button type="button" class="notice-dismiss" id="mo_saml_mo_idp"><span class="screen-reader-text">Dismiss this notice.</span></button>
	</div>
	</form>
		<script>
	...
	<table style="width:100%;">
		<tr>
			<h2 class="nav-tab-wrapper">
				...
				<a class="nav-tab <?php echo $active_tab == 'login' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'login'), htmlentities($_SERVER['REQUEST_URI'] )); ?>">Account Setup</a>
				<?php }?>
				<a class="nav-tab <?php echo $active_tab == 'config' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'config'), htmlentities($_SERVER['REQUEST_URI'] )); ?>">Identity Provider</a>
				<a class="nav-tab <?php echo $active_tab == 'save' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'save'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Service Provider</a>
				<?php if(mo_saml_is_customer_registered_saml()) {?>
				<a class="nav-tab <?php echo $active_tab == 'general' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'general'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Sign in Settings</a>
				<?php }?>
				<a class="nav-tab <?php echo $active_tab == 'opt' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'opt'),htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Attribute/Role Mapping</a>
				<a class="nav-tab <?php echo $active_tab == 'proxy' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'proxy'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Proxy Setup</a>
				<a class="nav-tab <?php echo $active_tab == 'help' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'help'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Help & FAQ</a>
				<a class="nav-tab <?php echo $active_tab == 'licensing' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'licensing'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Licensing Plans</a>
			</h2>
				...
				<div id="panel1">
					...
					<table class="mo_saml_settings_table">
						...
						<tr>
							...
							<input type="button" name="mo_saml_goto_login" id="mo_saml_goto_login" value="Already have an account?" class="button button-primary button-large" /></td>
						</tr>
					</table>
				</div>
			</div>
	...
	?>
		...
		<form name="f" method="post" action="">
			...
			<div class="mo_saml_table_layout">
				...
				<div id="panel1">
					<p><b>It seems you already have an account with miniOrange. Please enter your miniOrange email and password.<br/> <a target="_blank" href="https://auth.miniorange.com/moas/idp/resetpassword">Click here if you forgot your password?</a></b></p>
					<br/>
					<table class="mo_saml_settings_table">
						<tr>
							<td><b><font color="#FF0000">*</font>Email:</b></td>
	...
	?>
		<?php if(mo_saml_is_customer_registered_saml()){ ?>
			<div style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 2% 0px 2%;">
					...
					<?php if (get_option('mo_saml_free_version')) { ?>
						<span style="color:red;">*</span>These options are configurable in the <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing');?>"><b>standard, premium and enterprise</b></a> version of the plugin.</h3>
						<br /><br />
					<?php } ?>
			</div>
			<br />
...
function mo_saml_configuration_steps() {
	...
	<!-- <form  name="saml_form_am" method="post" action="" id="mo_saml_idp_config">-->
		...
		<tr>
			<?php if(!mo_saml_is_customer_registered_saml()) { ?>
				<td colspan="2"><div style="display:block;margin-top:10px;color:red;background-color:rgba(251, 232, 0, 0.15);padding:5px;border:solid 1px rgba(255, 0, 9, 0.36);">Please <a href="<?php echo add_query_arg( array('tab' => 'login'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Register or Login with miniOrange</a> to configure the miniOrange SAML Plugin.</div></td>
			<?php } ?>
		</tr>
			...
			<td colspan="2">
			 <div>
				...
				<form id="mo_saml_cloud_broker" method="post" action="">
					...
					<input type="radio" <?php checked(get_option('mo_saml_enable_cloud_broker') == 'miniorange' );?> id="mo_saml_enable_cloud_broker" name="mo_saml_enable_cloud_broker" value="miniorange" onchange="document.getElementById('mo_saml_cloud_broker').submit();" >Use miniOrange as an Identity Provider (IDP) ( <a href="#" id="help_working_title3" >Click Here<a></a> to know how the plugin works for this case. )<br/>

					<input type="radio" <?php checked(get_option('mo_saml_enable_cloud_broker') == 'true');?> id="mo_saml_enable_cloud_broker" name="mo_saml_enable_cloud_broker" value="true" onchange="document.getElementById('mo_saml_cloud_broker').submit();">Use miniOrange Identity broker service. ( <a href="#" id="help_working_title1" >Click Here<a></a> to know how the plugin works for this case. )<br/>

					<input type="radio" <?php checked(get_option('mo_saml_enable_cloud_broker') == 'false' || get_option('mo_saml_enable_cloud_broker') == '');?> id="mo_saml_enable_cloud_broker" name="mo_saml_enable_cloud_broker" value="false" onchange="document.getElementById('mo_saml_cloud_broker').submit();" >Use Your own Identity Provider ( <a href="#" id="help_working_title2" >Click Here<a></a> to know how the plugin works for this case. )<br/>
							...
							<div hidden id="help_working_desc3" class="mo_saml_help_desc">
								...
								<img src="<?php echo plugin_dir_url(__FILE__) . 'images/saml_working_womo1.png'?>" alt="Working of miniOrange SAML plugin" style="width: 55%;"/>
								</div>
								<ol>
...
<!-- miniOrange IdP Radio Key -->
			...
			<?php } else{ ?>
				...
				<h3><b>Step 1</b>:<h4>Link to Configure the Plug in:
						<a href="https://miniorange.com/wordpress-single-sign-on-(sso)" target='_blank'>Click Here to see the Guide for Configuring the plugin</b></a></b><h4>You will need the following information to configure your IdP. Copy it and keep it handy:</h4>
				<table border="1" style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 0px 0px 10px; margin:2px; border-collapse: collapse; width:98%">
					...
					<?php } else { ?>
						<tr>
							<td style="width:40%; padding: 15px;"><b>Default Relay State (Optional)</b></td>
							<td style="width:60%;  padding: 15px;">Available in the <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing');?>"><b>standard, premium and enterprise</b></a> plans of the plugin.</td>
						</tr>
						<?php if(get_option('mo_saml_enable_cloud_broker')!='true') { ?>
						<tr>
							<td style="width:40%; padding: 15px;"><b>Certificate (Optional)</b></td>
		...
		<table style="width:100%;">
			<tr>
				<td colspan="2">
					...
					<span style="float:right;margin-right:30px;"><a href="<?php echo admin_url()?>admin.php?page=mo_saml_settings&tab=save&action=upload_metadata"><input type="button" class="button button-primary button-large" value="Upload IDP Metadata"
					<?php
					if(!mo_saml_is_customer_registered_saml())echo"disabled";
					?>
			...
			<?php if(!mo_saml_is_customer_registered_saml()) { ?>
				<tr>
					<td colspan="2"><div style="display:block;color:red;background-color:rgba(251, 232, 0, 0.15);padding:5px;border:solid 1px rgba(255, 0, 9, 0.36);">Please <a href="<?php echo add_query_arg( array('tab' => 'login'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Register or Login with miniOrange</a> to configure the miniOrange SAML Plugin.</div></td>
				</tr>
			<?php } ?>
			...
			<?php if(get_option('mo_saml_enable_cloud_broker')=='miniorange'){?>
					<tr><td colspan="2"> <b>Note</b> : On miniOrange IdP, Go to <code>Apps</code> -> <code>Manage Apps</code> and click on <code> metadata</code> link given beside your WordPress SAML App to download IdP-Metadata XML file</td></tr>
					<?php }?>
					<tr><td>&nbsp;</td></tr>
			<tr>
				<td style="width:200px;"><strong>Identity Provider Name <span style="color:red;">*</span>:</strong></td>
				<td><input type="text" name="saml_identity_name" placeholder="Identity Provider name like ADFS, SimpleSAML, Salesforce" style="width: 95%;" value="<?php echo $saml_identity_name;?>" required <?php if(!mo_saml_is_customer_registered_saml()) echo 'disabled'?> title="Only alphabets, numbers and underscore is allowed"/></td>
			</tr>
			...
			<tr>
				<td></td>
				<td><b>Note</b> : You can find the <b>EntityID</b> in Your IdP-Metadata XML file enclosed in <code>EntityDescriptor</code> tag having attribute as <code>entityID</code> </td>
			...
			<tr>
				...
				<td><b>Note</b> : You can find the <b>SAML Login URL</b> in Your IdP-Metadata XML file enclosed in <code>SingleSignOnService</code> tag (Binding type: HTTP-Redirect)
		  ...
		  <tr>
			 <td colspan="2"><br/><b>NOTE: </b>Use attribute name <code>NameID</code> if Identity is in the <i>NameIdentifier</i> element of the subject statement in SAML Response.<br /><br /></td>
			  ...
			  <?php } else { ?>
				  ...
				  <tr>
			  		<td colspan="2"><br /><span style="color:red;">*</span>Username and Email are configurable in <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing');?>"><b>standard, premium and enterprise</b></a> versions of the plugin.<br />Group/Role is configurable in <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing');?>"><b>premium and enterprise</b></a> versions of the plugin.<br />Customized Attribute Mapping is configurable in the <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing');?>"><b>premium and enterprise</b></a> versions of the plugin. Customized Attribute Mapping means you can map any attribute of the IDP to the attributes of <b>user-meta</b> table of your database.</td>
			 	  </tr>
			  <?php } ?>
			  <tr>
				<td>&nbsp;</td>
			 ...
			 <form name="saml_form_am_role_mapping" method="post" action="">
				...
				<table width="98%" border="0" style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 0px 0px 10px;">
					...
					<?php if (get_option('mo_saml_free_version')) { ?>
					<tr>
					  	<td colspan="2"><br /><span style="color:red;">*</span>Customized Role Mapping options are configurable in the <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing');?>"><b>premium and enterprise</b></a> versions of the plugin. In the <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing');?>"><b>standard</b></a> version, you can only assign the default role to the user.</td>
					</tr>
					<?php } ?>
					<tr>
						<td>&nbsp;</td>
...
function mo_saml_proxy() {
		...
		<table style="width:100%;">
			...
			<tr>
				...
				<td><input type="text" name="mo_proxy_host" placeholder="Enter the host name" style="width: 95%;" value="<?php echo get_option("mo_proxy_host");?>"  /></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td><strong>Port Number:</strong></td>
				<td><input type="text" name="mo_proxy_port" placeholder="Enter the port number of the proxy" style="width: 95%;" value="<?php echo get_option("mo_proxy_port");?>" /></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td><strong>Username:</strong></td>
				<td><input type="text" name="mo_proxy_username" placeholder="Enter the username of proxy server" style="width: 95%;" value="<?php echo get_option("mo_proxy_username");?>" /></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td><strong>Password:</strong></td>
				<td><input type="password" name="mo_proxy_password" placeholder="Enter the password of proxy server" style="width: 95%;" value="<?php echo get_option("mo_proxy_password");?>"></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td>&nbsp;</td>
				<td><br /><input type="submit" name="submit" style="width:100px;" value="Save" class="button button-primary button-large" /> &nbsp;
				</td>
			</tr>
		</table><br/>
		<br/><br/>
					...
					<tr>
						<td class="mo_saml_help_cell">
							...
							<div hidden id="help_steps_desc" class="mo_saml_help_desc">
								<ul>
									<li>Step 1:&nbsp;&nbsp;&nbsp;&nbsp;Configure your Identity Provider by following <a href="<?php echo add_query_arg( array('tab' => 'config'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">these steps</a>.</li>
									<li>Step 2:&nbsp;&nbsp;&nbsp;&nbsp;Download X.509 certificate from your Identity Provider.</li>
									<li>Step 3:&nbsp;&nbsp;&nbsp;&nbsp;Enter appropriate values in the fields in <a href="<?php echo add_query_arg( array('tab' => 'save'), htmlentities($_SERVER['REQUEST_URI'] ) ); ?>">Configure Service Provider</a>.</li>
...
function mo_saml_show_pricing_page() { ?>
    ...
    <tr style="background-color:#93ca3a;">
      ...
      <th class="text-center" width="25%"><h3>Standard</h3><p class="mo_plan-desc"></p><h3>$249 - One Time Payment<br><br><span>
	  ...
	  <th class="text-center" width="25%"><h3>Premium</h3><p class="mo_plan-desc"></p><h3>$449 - One Time Payment<br><br><span>
	  ...
	  <th class="text-center" width="25%"><h3>Enterprise</h3><p class="mo_plan-desc"></p><h3>$499 - One Time Payment<br><br><span>
	  <a name="upgrade_btn" class="button button-default button-large" target="_blank" href="https://www.miniorange.com/contact">Contact Us</a></span></h3></th>
